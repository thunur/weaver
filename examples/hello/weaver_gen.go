...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦8d621687:wEaVeReDgE:github.com/thunur/weaver/Main→github.com/thunur/weaver/examples/hello/Reverser⟧\n⟦17f36ff9:wEaVeRlIsTeNeRs:github.com/thunur/weaver/Main→hello⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/thunur/weaver/examples/hello/Reverser",
		Iface: reflect.TypeOf((*Reverser)(nil)).Elem(),
		Impl:  reflect.TypeOf(reverser{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return reverser_local_stub{impl: impl.(Reverser), tracer: tracer, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/hello/Reverser", Method: "Reverse", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/hello/Reverser", Method: "Reverse", Remote: true, Generated: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
