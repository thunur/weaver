...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/thunur/weaver/examples/bankofanthos/transactionhistory/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, getTransactionsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/bankofanthos/transactionhistory/T", Method: "GetTransactions", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, getTransactionsMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/bankofanthos/transactionhistory/T", Method: "GetTransactions", Remote: true, Generated: true})}
		},
