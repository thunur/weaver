...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "github.com/thunur/weaver/examples/fakes/Clock",
		Iface: reflect.TypeOf((*Clock)(nil)).Elem(),
		Impl:  reflect.TypeOf(clock{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return clock_local_stub{impl: impl.(Clock), tracer: tracer, unixMicroMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/fakes/Clock", Method: "UnixMicro", Remote: false, Generated: true})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return clock_client_stub{stub: stub, unixMicroMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/thunur/weaver/examples/fakes/Clock", Method: "UnixMicro", Remote: true, Generated: true})}
		},
